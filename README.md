...
A simple project starter for the **Code Biruni** ecosystem by **Robius Sani**.
Quickly scaffold a **MERN (Express.js) backend** with a clean structure and essential setup.
